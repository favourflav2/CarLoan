...
import { add_Book, add_Content_Creator, add_Video_Link, get_All_Books, get_All_Content_Creators, get_All_Vidoe_Links_By_Id, update_Book_Img, } from "../../controller/tables/howToInvest/howToInvestTable.js";
