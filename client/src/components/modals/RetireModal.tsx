...
export default function RetireModal({setFirstModal}:Props) {
  ...
  return (
    ...
    >
      <div className=" absolute top-[50%] left-[50%] transfrom -translate-x-[50%] -translate-y-[50%] no-scrollbar dark:bg-homeBg bg-lightHomeBg sm:w-[70%] md:w-[60%] w-full sm:max-h-[95%] sm:h-auto h-full  rounded-lg overflow-y-auto" > 
        {/* Content */}
        <div className="w-full h-full flex flex-col px-4 py-2 overflow-y-auto no-scrollbar" ref={myRef} >
         ...
         <div className="w-full flex justify-between items-center my-2">
          ...
          {currentStepIndex < steps && <button className="p-2 dark:bg-gray-300 bg-black dark:text-black text-gray-300  min-w-[100px] rounded-md" onClick={next}>Next</button>}
