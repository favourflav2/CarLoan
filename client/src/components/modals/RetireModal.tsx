...
export default function RetireModal({setFirstModal}:Props) {
  ...
  return (
    ...
    >
      <div className=" absolute top-[50%] left-[50%] transfrom -translate-x-[50%] -translate-y-[50%] no-scrollbar dark:bg-homeBg bg-lightHomeBg sm:w-[70%] md:w-[60%] w-full sm:max-h-[95%] sm:h-auto h-full  rounded-lg overflow-y-auto" ref={myRef}> 
        {/* Content */}
