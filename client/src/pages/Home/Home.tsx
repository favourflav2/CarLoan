...
import { clearAllFilters, setCurrentPage, setMakeAndModalRedux, setMileagePersist, setPricePersist, setSearchState, setSortByState } from "../../redux/features/websiteSlice";
              ...
              <div className="w-full h-full flex flex-col p-2 flex-wrap relative ">
                ...
                <div className="w-full h-auto flex flex-col">
                  ...
                  {/* Clear All */}
                      ...
                      {getNumberOfFiltersForBagde({nameFilters:reduxMakeAndModalStates, pricefilters:price, mileageFilter:mileage}) > 0 && <div className=" w-full flex justify-center sticky bottom-0   h-[60px]">
                          <button className="w-full h-[50px] bg-black text-gray-300 rounded-full" onClick={()=>dispatch(clearAllFilters())}>Clear All</button>
                      </div>}
