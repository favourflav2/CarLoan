...
export interface IMobilePictureBoxProps {}

export default function MobilePictureBox(props: IMobilePictureBoxProps) {
  const { lightAndDarkMode } = UseSelector((state) => state.app);
  return (
    <div className=" lg:hidden flex flex-col w-full h-full text-lightText dark:text-darkText mt-[50px] mb-5">
      {/* Content */}
      <div className="w-full grid grid-cols-1 gap-[60px] h-auto">
        {/* Modal Box/Img */}
        ...
        <div className="w-full flex flex-col justify-center items-center">
          <Zoom>
            <img src={lightAndDarkMode ? darkInputs : inputs} alt="" className="rounded-lg object-cover max-h-[500px] border border-gray-300 dark:border-gray-500" />
          </Zoom>
          <div className="w-auto h-auto justify-normal items-start flex flex-col ">
            {/* Retirement */}
