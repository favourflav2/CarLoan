  ...
  return (
    <div className="w-full h-full flex flex-col p-4 text-lightText dark:text-darkText">
      ...
      <div className="w-full flex flex-col h-full">
        ...
        {/* title */}
        <h1 className="text-[19px]  font-bold">{selectedGoal.modal} {selectedGoal.name}</h1>
        ...
        <div className="w-auto flex items-center">
            ...
            <div className="w-auto flex flex-col ml-4 ">
                <h1 className="text-[15px]"><span className="font-bold text-[15px]">Car Name/Modal:</span> {selectedGoal.modal} {selectedGoal.name}</h1>
                <h1 className="text-[15px]"><span className="font-bold text-[15px]">Price:</span> {USDollar.format(selectedGoal.price)}</h1>
                <h1 className="text-[15px]"><span className="font-bold text-[15px]">Down Payment:</span> {USDollar.format(selectedGoal.downPayment)}</h1>
                <h1 className="text-[15px]"><span className="font-bold text-[15px]">Miles:</span> {selectedGoal.mileage.toLocaleString()} miles</h1>
                <h1 className="text-[15px]"><span className="font-bold text-[15px]">Income:</span> {USDollar.format(selectedGoal.salary)}</h1>
                <h1 className="text-[15px]"><span className="font-bold text-[15px]">Term:</span> {selectedGoal.term} months</h1>
                <h1 className="text-[15px]"><span className="font-bold text-[15px]">Interest Rate:</span> {selectedGoal.interest}% </h1>

                <h1 className="text-[15px] mt-3"><span className="font-bold text-[15px]">Loan Amount:</span> {USDollar.format(selectedGoal.price - selectedGoal.downPayment)}</h1>
            </div>
        </div>
