...
listenerMiddleware.startListening.withTypes<RootState, AppDispatch>()({
  ...
  listenerMiddleware.startListening.withTypes<RootState, AppDispatch>()({
    matcher: isAnyOf(createRetireGoal.fulfilled,deleteRetireGoal.fulfilled, updateRetireGoal.fulfilled, updateRetireTableName.fulfilled, createHouseGoal.fulfilled, updateHouseGoal.fulfilled, deleteHouseGoal.fulfilled, updateHouseGoalOppCost.fulfilled, updateHouseGoalImg.fulfilled, updateHouseGoalAddress.fulfilled, hideAndShowHouseInputs.fulfilled, hideAndShowHouseOppCostInputs.fulfilled, createCarGoal.fulfilled, updateCarGoal.fulfilled, updateCarName.fulfilled, deleteCarGoal.fulfilled ),
    effect: async (_action, listenerApi) => {
