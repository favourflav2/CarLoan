...
import { createHouseGoal, createRetireGoal, deleteHouseGoal, deleteRetireGoal, getAllGoals, updateHouseGoal, updateHouseGoalOppCost, updateRetireGoal, updateRetireTableName } from "../features/tablesSlice";
...
listenerMiddleware.startListening.withTypes<RootState, AppDispatch>()({
  ...
  listenerMiddleware.startListening.withTypes<RootState, AppDispatch>()({
    matcher: isAnyOf(createRetireGoal.fulfilled,deleteRetireGoal.fulfilled, updateRetireGoal.fulfilled, updateRetireTableName.fulfilled, createHouseGoal.fulfilled, updateHouseGoal.fulfilled, deleteHouseGoal.fulfilled, updateHouseGoalOppCost.fulfilled),
    effect: async (_action, listenerApi) => {
